...
public class SolutionTest {
    ...
    public void largestNumber() {
        ...
        Assert.assertEquals("9534330",s.largestNumber( nums ));
    }

    @Test
    public void largestNumber2() {
        int[] nums = new int[] {128,12};
        Assert.assertEquals("12812",s.largestNumber( nums ));
    }

    @Test
    public void largestNumber3() {
        int[] nums = new int[] {128,12, 1};
        Assert.assertEquals("128121",s.largestNumber( nums ));
    }

    @Test
    public void largestNumber4() {
        int[] nums = new int[] {999999998,999999997,999999999};
        Assert.assertEquals("999999999999999998999999997", s.largestNumber( nums ));
    }

    @Test
    public void largestNumber5() {
        int[] nums = new int[] {0,0,0};
        Assert.assertEquals("0", s.largestNumber( nums ));
    }
