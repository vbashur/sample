...
public class SolutionUnitTest {
    ...
    public void testGcd() {
        ...
        Assert.assertEquals(Long.valueOf(12), s.gcd(36, 24));
        Assert.assertEquals(Long.valueOf(1), s.gcd(1, 24));
        Assert.assertEquals(Long.valueOf(8), s.gcd(16, 24));
    }
    ...
    public void testLcm() {
        ...
        Solution s = new Solution();
        Assert.assertEquals(Long.valueOf(48), s.lcm(24, 48));
        Assert.assertEquals(Long.valueOf(48), s.lcm(48, 24));
        Assert.assertEquals(Long.valueOf(96), s.lcm(32, 24));
        Assert.assertEquals(Long.valueOf(24), s.lcm(12, 24));
        Assert.assertEquals(Long.valueOf(48), s.lcm(16, 24));
    }
